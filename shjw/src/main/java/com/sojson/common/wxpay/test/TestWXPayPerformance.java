...
import com.sojson.common.wxpay.WXPay;
...
public class TestWXPayPerformance {
	...
	public void test001() {
		...
		try {
			...
			System.out.println("+++++++++++++++++");
			System.out.println(WXPayUtil.isSignatureValid(xmlStr,
					config.getKey()));
	...
	public void testUnifiedOrderSpeed() throws Exception {
		...
		for (int i = 0; i < 100; ++i) {
			...
			System.out.println(String.format("time used to unified order: %ld",
					endTs - startTs));
			Thread.sleep(2000);
		}
	...
	public void testRefundSpeed() throws Exception {
		...
		for (int i = 0; i < 1000; ++i) {
			...
			dodo.doRefund();
			long endTs = System.currentTimeMillis();
			System.out.println(String.format("time used to refund: %ld", endTs
					- startTs));
			Thread.sleep(2 * 1000);
		}
