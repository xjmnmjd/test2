...
public class UUserServiceImpl extends BaseMybatisDao<UUserMapper> implements UUserService {
   ...
   @Override
	 ...
	 */
	@Override
	public List<UUser> userList(Map<String, Object> map) {
	...
	@Override
	public UUser findOne_user(Long id) {
		// TODO Auto-generated method stub
		return userMapper.findOne_user(id);
	}
	/**
	 * 修改用户
	 */
	 ...
	 */
	@Override
	public void update_user_leave(UUser user) {
		userMapper.update_user_leave(user);		
	}
	@Override
	public List<UUser> user_kfy() {
		// TODO Auto-generated method stub
		return userMapper.user_kfy();
	}

	@Override
	public void delete_User(long id) {
		userMapper.delete_User(id);
	}
