package com.sojson.common.utils.ocr.util;
...
import com.sojson.common.utils.ocr.constant.SystemHeader;
...
public class SignUtil {
	...
	public static String sign(String secret, String method, String path,
		...
		try {
			...
			return new String(Base64.encodeBase64(hmacSha256
					.doFinal(buildStringToSign(method, path, headers, querys,
							bodys, signHeaderPrefixList).getBytes(
	 ...
	 * @return 待签名
	 */
	private static String buildResource(String path,
	...
	private static String buildHeaders(Map<String, String> headers,
		...
		if (null != signHeaderPrefixList) {
			...
			if (null != headers) {
				...
				headers.put(SystemHeader.X_CA_SIGNATURE_HEADERS,
						signHeadersStringBuilder.toString());
			}
		}
