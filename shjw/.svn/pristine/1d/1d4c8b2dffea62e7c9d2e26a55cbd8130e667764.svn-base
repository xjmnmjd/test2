package com.sojson.common.xj.controller;
...
import com.sojson.common.xj.MyMd5Util;
...
public class AccountWeiXinController {
	...
	/*
	 * @Autowired private AccountWalletService accountWalletService;
	 */
	// 微信统一下单接口路径
	...
	public String uniformorder(HttpServletRequest request)
		...
		try {
			...
			parame.put("total_fee", BigDecimal.valueOf(Long.parseLong(money))
					.multiply(new BigDecimal(100)).toString());// 消费金额
			...
			JSONObject jsonObject = JSONObject.parseObject(XmltoJsonUtil
					.xml2JSON(content));
	...
	public static String createSign(SortedMap<Object, Object> parame) {
		...
		buffer.append("key=" + BaseUtils.AppSecret);
	...
	public static void main(String[] args) throws Exception {
		String str = HttpUtil.sendPost(
				"http://localhost:8012/shjw/WeiXinPay/notify.shtml",
