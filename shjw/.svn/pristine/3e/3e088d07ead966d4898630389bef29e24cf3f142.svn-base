...
public class Sender {
	 ...
	 * 发送POST请求
	 */
	public static String sendPost(String url, String body, String ak_id,
			String ak_secret) throws Exception {
	...
	public static void main(String[] args) throws Exception {
		// 发送POST请求示例
		String ak_id = "LTAInpjdgCD6tBdP"; // 用户ak
		String ak_secret = "qFNNnILmAjA9mIS6urzpdwcLOn6Z35"; // 用户ak_secret
		...
		String body = "{\"inputs\":[{\"image\":{\"dataType\":50,\"dataValue\":"
				+ code + "}}]}";
		
		//String body = "{\"param1\": \"xxx\", \"param2\":\"xxx\"}";
		System.out.println("response body:"
				+ sendPost(url, body, ak_id, ak_secret));
		/*// 发送GET请求
		...
		System.out
				.println("response body:" + sendGet(url1, ak_id1, ak_secret1));*/
	}
}
