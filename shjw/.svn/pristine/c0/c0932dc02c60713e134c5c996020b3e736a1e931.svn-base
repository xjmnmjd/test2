...
public class DemoTestSubmitController extends BaseController {
	...
	final static String OUT_MAP = DemoTestSubmitController.class
			.getCanonicalName() + "_outMap";
	final static String URL_PART = DemoTestSubmitController.class
			.getCanonicalName() + "_url";
	...
	public SubmitDto submit(@PathVariable("urlPart") String urlPart,
